...
function moveNoteOne(timestamp){
	 noteOneWobble++;
	 upOne++;
    leftpos = Math.sin(noteOneWobble*0.03)*noteOneWobble*0.5
   // gsap.set(mc_musical_note_one,{x:leftpos+100,rotation:leftpos,y:"-="+leftpos*0.025
    gsap.set(mc_musical_note_one,{x:leftpos+note_oneX,rotation:leftpos,y:"-="+upOne*0.01});  
...
function moveNoteTwo(timestamp){
	 noteTwoWobble++;
	 upTwo++;
    leftpos = Math.sin(noteTwoWobble*0.075)*noteTwoWobble
   // gsap.set(mc_musical_note_one,{x:leftpos+100,rotation:leftpos,y:"-="+leftpos*0.025
    gsap.set(mc_musical_note_two,{x:leftpos+note_twoX,rotation:leftpos,y:"-="+upTwo*0.02});  
 ...
 function moveNoteThree(timestamp){
	 noteThreeWobble++;
	 upThree++;
    leftpos = Math.sin(noteThreeWobble*0.04)*noteThreeWobble
   // gsap.set(mc_musical_note_one,{x:leftpos+100,rotation:leftpos,y:"-="+leftpos*0.025
    gsap.set(mc_musical_note_three,{x:leftpos+note_threeX,rotation:leftpos,y:"-="+upThree*0.01});  
